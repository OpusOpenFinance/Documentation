...
alternate_lang:
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/operacoesDeCredito/emprestimos/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/operacoesDeCredito/emprestimos/"
      lang: "es"
---
...
The documentation for the Loans API to be built in the *integration layer* can be found [**here**][API-Emprestimo].

To download the YAML/OAS file containing the API specification, click [**here**](../anexos/yml/operacoesDeCredito/en-loans-2-4-0.yml){:download="en-loans-2-4-0.yml"}.
