...
To download the YAML/OAS file containing the API specification, click [**here**](../anexos/yml/operacoesDeCredito/en-overdraft-2-4-0.yml){:download="en-overdraft-2-4-0.yml"}.
