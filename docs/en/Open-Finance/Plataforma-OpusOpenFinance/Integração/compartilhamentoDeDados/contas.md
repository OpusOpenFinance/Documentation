...
lang: "en"
alternate_lang:
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/contas/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/contas/"
      lang: "es"
---
...
To download the YAML/OAS file containing the Accounts API specification, click [**here**](./anexos/yml/en-accounts-2-4-1.yml){:download="en-accounts-2-4-1.yml"}.

To download the YAML/OAS file containing the *common* API specification, click [**here**](./anexos/yml/en-opusCommons-1-0-0.yml){:download="en-opusCommons-1-0-0.yml"}.
