...
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/openFinanceBrasil/requisitosNF/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/openFinanceBrasil/requisitosNF/"
      lang: "es"
---
...
To assess the above non-functional requirements across all endpoints, [click right here](https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/17989722/Limites+de+tr+fego).
