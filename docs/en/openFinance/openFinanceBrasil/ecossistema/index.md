...
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/openFinanceBrasil/ecossistema/index/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/openFinanceBrasil/ecossistema/index/"
      lang: "es"
---
...
2. **Phase 2 - Customer Data**
    This phase is related to instituion users to share their personal financial data between different Open Finance participants. The whole list of products possible to share can be found on [this link](../perfisParticipacao/transmissorDeDados.html).
3. **Phase 3 - Services**
