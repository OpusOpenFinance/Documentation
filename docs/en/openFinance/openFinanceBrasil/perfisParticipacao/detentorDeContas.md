...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/openFinanceBrasil/perfisParticipacao/detentorDeContas/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/openFinanceBrasil/perfisParticipacao/detentorDeContas/"
      lang: "es"
---
...
The authorization process to make payments is done by the customer through a **complete consent journey**. More details can be found [right here](../jornadaConsentimento/index.html).
...
1. Complete the [deployment process](../../opusOpenFinance/implantacaoDaPlataforma/index.html).
