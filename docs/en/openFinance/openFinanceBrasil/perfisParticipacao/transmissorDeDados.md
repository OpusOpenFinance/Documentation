...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/openFinanceBrasil/perfisParticipacao/transmissorDeDados/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/openFinanceBrasil/perfisParticipacao/transmissorDeDados/"
      lang: "es"
---
...
> The regulatory standard establishes limits, called *operational limits*, which define the maximum quotas of requests a data receiver institution can send to a data transmitter institution. The current operational limits in *Open Finance Brasil* can be found [right here][Operational-Limits].
...
The authorization process for data sharing follows a **complete consent journey**. For more information, click [on here][ConsentJourney].
...
[Deployment]: ../../opusOpenFinance/implantacaoDaPlataforma/index.html
...
[Integration-Layer]: ../../opusOpenFinance/integracaoDaPlataforma/index.html
