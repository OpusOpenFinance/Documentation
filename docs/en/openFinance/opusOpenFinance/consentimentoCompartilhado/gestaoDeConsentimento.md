...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/consentimentoCompartilhado/gestaoDeConsentimento/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/consentimentoCompartilhado/gestaoDeConsentimento/"
      lang: "es"
---

## What Our Solution Implements

Once the user logs in through your application, they will have access to a series of screens in compliance with the latest Banco Central regulations.
...
The developed screens are organized into:

- **Management Screens (Data Transmission and Reception)**, which enable consent and account linkage management, providing full control over shared information.
...
![Management Screens - Transmission](./anexos/imagens/gestaoDeConsentimento/en-telasDeGestaoTransmissao.png)
...
![Consent Control Panel Screen](./anexos/imagens/gestaoDeConsentimento/en-tela1PainelDeControleTransmissao.png)
...
![Consent Revocation Screen](./anexos/imagens/gestaoDeConsentimento/en-tela2RevogDeConsentTransmissao.png)
...
![Linked Accounts Management Screen](./anexos/imagens/gestaoDeConsentimento/en-tela3GestDeContVincTransmissao.png)

### Reception - Management Screens (Item 05 - Management Area)

**Note:** The screens presented in this section are contained in the User Experience Guide, Item 05 – Management Area. More details in the link.

The management screens focus on managing Open Finance consents. These screens provide the user with clear and efficient control over their data reception, data sharing, and payments consents.

#### Screen 1: Consent Control Panel - Reception

![Consent Control Panel - Reception Screen](./anexos/imagens/gestaoDeConsentimento/en-tela1PainelDeContrConsentRecepcao.png)
...
![Sharing List Screen (Received and Transmitted)](./anexos/imagens/gestaoDeConsentimento/en-tela2ListDeCompartRecepcao.png)

#### Screen 3: Consent Revocation

The user can revoke a consent directly from this screen, receiving a warning that this action is irreversible and which services will be affected.

![Consent Revocation Screen](./anexos/imagens/gestaoDeConsentimento/en-tela3RevogConsentRecepcao.png)
