...
The definitions of the API in Open API Specification format can be found at [**this link**][API-backoffice].

To download the YAML/OAS file containing the API specification, click on [**this link**](../openFinanceBrasil/perfisParticipacao/anexos/yml/en-oasOOFDados.yml){:download="en-oasOOFDados.yml"}.
