...
- Preparation of evidence for submission to OpenID ([RP and OP certifications](../../openFinanceBrasil/certificacoesECertificados.html)).
...
- Integration of the institution’s back-end systems with the product, according to the [financial institution’s participation profile](../../openFinanceBrasil/perfisParticipacao/index.html). Typically, [this involves building the *integration layer*](../integracaoDaPlataforma/index.html) adapted to the institution’s back-end systems.
...
- Acquisition of [digital certificates](../../openFinanceBrasil/certificacoesECertificados.html).
...
[Implementation Roadmap]: ./anexos/imagens/en-index-roadmap.png
