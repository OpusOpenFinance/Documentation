...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/appEWeb/internetBanking/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/appEWeb/internetBanking/"
      lang: "es"
---
...
The definitions of the REST API provided by the Authorization Server can be consulted on [this link][API-Mobile].
...
![Sequence Diagram](./anexos/imagens/internetBanking-diagramaSequencia.svg)
