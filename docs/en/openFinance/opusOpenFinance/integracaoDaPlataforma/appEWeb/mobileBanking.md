...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/appEWeb/mobileBanking/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/appEWeb/mobileBanking/"
      lang: "es"
---
...
![Sequence Diagram](./anexos/imagens/mobileBanking-diagramaSequencia.svg)

### Open API Specification

The definitions of the REST API provided by the Authorization Server for the mobile app can be found on [this link][API-Mobile].

### Mock for Integration

To assist in the development of the integration, a *mock* is available in the [Mockoon](https://mockoon.com/) tool and is defined in this [JSON file](./anexos/json/mobileBanking/en-mockoon.json).
