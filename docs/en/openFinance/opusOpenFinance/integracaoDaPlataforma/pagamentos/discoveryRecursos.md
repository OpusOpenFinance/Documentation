...
lang: "en"
alternate_lang: 
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/pagamentos/discoveryRecursos/"
      lang: "pt-br"
...
When creating consent, all permissions for the data groups for which consent is desired must be sent. This set of necessary permissions, called permission groups, are designated as per the table below ([the link](https://openbanking-brasil.github.io/openapi/swagger-apis/consents/1.0.3.yml)
...
More examples of request and response for the “approvePaymentConsentCreation" route can be found [right here](./anexos/json/discoveryRecursos/approvePaymentConsentCreation_v3).
