...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/index/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/index/"
      lang: "es"
---
...
In the case of data integration, required for the [*data transmitter* profile][Transmissor], the detailed integration model can be found [**in this link**][Compartilhamento].

In the case of payments, required for the [*account holder* profile][Detentor], the detailed integration model can be found [**in this link**][Pagamentos].

[Compartilhamento]: ./compartilhamentoDeDados/index.html
[Pagamentos]: ./pagamentos/index.html
[Integração app-web]: ./appEWeb/index.html
