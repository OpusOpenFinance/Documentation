...
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/dadosAbertos/index/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/dadosAbertos/index/"
      lang: "es"
---
...
| :-: | :-----------: | :---------------: |
| Service channels | [The link][Channels] | [JSON][Channels-JSON] |
| Accounts | [The link][Accounts] | [JSON][Accounts-JSON] |
| Loans | [The link][Loans] | [JSON][Loans-JSON] |
| Financings | [The link][Financings] | [JSON][Financings-JSON] |
| Account Overdraft | [The link][Unarranged] | [JSON][Unarranged-JSON] |
| Invoice financings | [The link][Inv-financings] | [JSON][Inv-financings-JSON] |
| Credit card | [The link][CreditCard] | [JSON][CreditCard-JSON] |
| Investments | [The link][Investments] | [JSON][Investments-JSON] |
| Insurance | [The link][Insurance] | [JSON][Insurance-JSON] |
| Acquiring | [The link][Acquiring] | [JSON][Acquiring-JSON] |
| Capitalization bonds | [The link][Capitalization] | [JSON][Capitalization-JSON] |
| Pension | [The link][Pension] | [JSON][Pension-JSON] |
| Exchange | [The link][Exchange] | [JSON][Exchange-JSON] |
