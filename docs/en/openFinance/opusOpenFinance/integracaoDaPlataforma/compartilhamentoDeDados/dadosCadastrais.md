...
lang: "en"
alternate_lang:
    - path: "/Documentation/en/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/dadosCadastrais/"
      lang: "en"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/dadosCadastrais/"
      lang: "es"
---
...
The documentation for the Personal Data API to be built in the *integration layer* can be found on [**this link**][API-Dados-cadastrais].

To download the YAML/OAS file containing the API specification, click on [**this link**](./anexos/yml/en-accounts-2-4-1.yml){:download="en-accounts-2-4-1.yml"}.
