...
lang: "en"
alternate_lang:
    - path: "/Documentation/en/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/contas/"
      lang: "en"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/contas/"
      lang: "es"
---
...
The documentation for the Accounts API to be built in the *integration layer* can be found on [**this link**][API-Contas].

The documentation for the *common* API can be found on [**this link**][API-Common].

To download the YAML/OAS file containing the Accounts API specification, click [**right here**](./anexos/yml/en-accounts-2-4-1.yml){:download="en-accounts-2-4-1.yml"}.

To download the YAML/OAS file containing the *common* API specification, click [**right here**](./anexos/yml/en-opusCommons-1-0-0.yml){:download="en-opusCommons-1-0-0.yml"}.
