...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/cambio/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/cambio/"
      lang: "es"
---
...
The documentation for the Foreign Exchange API to be built in the *integration layer* can be found on [**this link**][API-Câmbio].

To download the YAML/OAS file containing the API specification, click on [**this link**](./anexos/yml/en-exchange-1-0-0.yml){:download="en-exchange-1-0-0.yml"}.
