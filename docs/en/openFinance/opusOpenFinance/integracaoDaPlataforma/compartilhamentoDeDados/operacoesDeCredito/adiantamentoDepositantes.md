...
lang: "en"
alternate_lang:
    - path: "/Documentation/en/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/adiantamentoDepositantes/"
      lang: "en"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/adiantamentoDepositantes/"
      lang: "es"
---
...
The documentation for the Unarranged Accounts Overdraft API to be built in the *integration layer* can be found on[**this link**][API-Adiantamento].

To download the YAML/OAS file containing the API specification, click on [**this link**](../anexos/yml/operacoesDeCredito/en-overdraft-2-4-0.yml){:download="en-overdraft-2-4-0.yml"}.
