...
lang: "en"
alternate_lang:
    - path: "/Documentation/en/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/direitosCreditorios/"
      lang: "en"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/direitosCreditorios/"
      lang: "es"
---
...
The documentation for the Invoice Financing API to be built in the *integration layer* can be found on [**this link**][API-Direitos-Creditórios].

To download the YAML/OAS file containing the API specification, click on [**this link**](../anexos/yml/operacoesDeCredito/en-invoiceFinancings-2-3-0.yml){:download="en-invoiceFinancings-2-3-0.yml"}.
...
[API-Direitos-Creditórios]: ../../../../../../swagger-ui/index.html?api=en-direitos-creditorios
