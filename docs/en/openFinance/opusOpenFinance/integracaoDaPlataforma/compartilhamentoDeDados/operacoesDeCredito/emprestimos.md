...
lang: "en"
alternate_lang:
    - path: "/Documentation/en/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/emprestimos/"
      lang: "en"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/emprestimos/"
      lang: "es"
---
...
The documentation for the Loans API to be built in the *integration layer* can be found on [**this link**][API-Emprestimo].

To download the YAML/OAS file containing the API specification, click on [**this link**](../anexos/yml/operacoesDeCredito/en-loans-2-4-0.yml){:download="en-loans-2-4-0.yml"}.
...
[API-Emprestimo]: ../../../../../../swagger-ui/index.html?api=en-emprestimos
