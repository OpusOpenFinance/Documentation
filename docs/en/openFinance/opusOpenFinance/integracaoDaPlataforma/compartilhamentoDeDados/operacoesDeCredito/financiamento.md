...
lang: "en"
alternate_lang:
    - path: "/Documentation/en/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/financiamento/"
      lang: "en"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/financiamento/"
      lang: "es"
---
...
The documentation for the Financing API to be built in the *integration layer* can be found on [**this link**][API-Financiamento].

To download the YAML/OAS file containing the API specification, click on [**this link**](../anexos/yml/operacoesDeCredito/en-financings-2-3-0.yml){:download="en-financings-2-3-0.yml"}.
...
[API-Financiamento]: ../../../../../../swagger-ui/index.html?api=en-financiamentos
