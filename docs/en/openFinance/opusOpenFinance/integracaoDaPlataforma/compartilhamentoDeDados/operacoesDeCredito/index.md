...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/index/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/index/"
      lang: "es"
---
...
The official documentation of *Open Finance Brasil* has a table summarizing the credit operations associated with each modality, as well as the API that should be responsible for it, which can be viewed [right here][Tabela-Crédito-OFB].
...
| API                             | Link                             |
| :-----------------------------: | :------------------------------: |
| Loans                           | [The link][Empréstimo]           |
| Financing                       | [The link][Financiamento]        |
| Unarranged Accounts Overdraft   | [The link][Adiantamento]         |
| Invoice Financing               | [The link][Direitos-Creditórios] |

[Empréstimo]: ./emprestimos.html
[Financiamento]: ./financiamento.html
[Adiantamento]: ./adiantamentoDepositantes.html
[Direitos-Creditórios]: ./direitosCreditorios.html
