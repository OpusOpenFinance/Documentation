...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaFixaBancaria/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaFixaBancaria/"
      lang: "es"
---
...
The documentation for the bank fixed income API to be built in the integration layer can be found on [**this link**][API-Bank-Fixed-Income]

To download the YAML/OAS file containing the API specification, click on [**this link**](../anexos/yml/investimentos/en-bankFixedIncomes.yml){:download="en-bankFixedIncomes.ym"}.
