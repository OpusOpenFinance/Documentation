...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaVariavel/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaVariavel/"
      lang: "es"
---
...
The documentation for the variable income API to be built in the integration layer can be found on [**this link**][API-Variable-Income]

To download the YAML/OAS file containing the API specification, click on [**this link**](../anexos/yml/investimentos/en-variableIncomes.yml){:download="en-variableIncomes.yml"}.
