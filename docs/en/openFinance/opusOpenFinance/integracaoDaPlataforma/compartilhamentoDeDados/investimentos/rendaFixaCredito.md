...
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaFixaCredito/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaFixaCredito/"
      lang: "es"
---
...
The documentation for the credit fixed income API to be built in the integration layer can be found on [**this link**][API-Credit-Fixed-Income]

To download the YAML/OAS file containing the API specification, click on [**this link**](../anexos/yml/investimentos/en-creditFixedIncomes.yml){:download="en-creditFixedIncomes.yml"}.
