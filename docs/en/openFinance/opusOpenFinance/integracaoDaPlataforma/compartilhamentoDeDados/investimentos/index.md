...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/index/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/index/"
      lang: "es"
---
...
The official documentation of *Open Finance Brasil* has a table summarizing the investments associated with each modality, as well as the API that should be responsible for it, which can be viewed [right here][Tabela-Investimento-OFB].
...
| API | Link |
| :-: | :--: |
| Bank fixed income | [The link](./rendaFixaBancaria.html) |
| Credit fixed income | [The link](./rendaFixaCredito.html) |
| Variable income | [The link](./rendaVariavel.html) |
| Treasury bonds | [The link](./titulosTesouroDireto.html) |
| Investment funds | [The link](./fundosInvestimento.html) |
