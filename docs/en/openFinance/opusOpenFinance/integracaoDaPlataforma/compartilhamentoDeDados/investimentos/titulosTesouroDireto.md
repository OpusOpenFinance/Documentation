...
lang: "en"
alternate_lang:
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/titulosTesouroDireto/"
      lang: "pt-br"
    - path: "/Documentation/es/openFinance/opusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/titulosTesouroDireto/"
      lang: "es"
---
...
{: .note}
We are talking here about *Tesouro Direto*. A brief explanation about this kind of treasury bonds can be found on [this link][OOF-Investimentos].
...
The documentation for the treasury bonds API to be built in the integration layer can be found on [**this link**][API-Treasury-Bonds]

To download the YAML/OAS file containing the API specification, click on [**this link**](../anexos/yml/investimentos/en-treasuryBonds.yml){:download="en-treasuryBonds.yml"}.
...
[OOF-Investimentos]: ../investimentos/index.html
