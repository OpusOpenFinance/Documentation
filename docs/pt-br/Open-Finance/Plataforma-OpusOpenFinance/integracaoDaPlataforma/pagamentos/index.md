...
lang: "pt-br"
alternate_lang: 
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/pagamentos/index/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/pagamentos/index/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](./anexos/yml/paymentIntegration-0.1.0.yml){:download="paymentIntegration-0.1.0.yml"}.
