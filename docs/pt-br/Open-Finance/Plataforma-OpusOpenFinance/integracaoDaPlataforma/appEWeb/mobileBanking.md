...
lang: "pt-br"
alternate_lang: 
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/appEWeb/mobileBanking/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/appEWeb/mobileBanking/"
      lang: "es"
---
...
![Diagrama de sequência](./anexos/imagens/mobileBanking-diagramaSequencia.svg)
...
ferramenta [Mockoon](https://mockoon.com/) e definido nesse [arquivo JSON](./anexos/json/mobileBanking/mockoon.json).
