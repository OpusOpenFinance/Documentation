...
lang: "pt-br"
alternate_lang:
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/direitosCreditorios/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/direitosCreditorios/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](../anexos/yml/operacoesDeCredito/invoiceFinancings-2-3-0.yml){:download="invoiceFinancings-2-3-0.yml"}.
...
[API-Direitos-Creditórios]: ../../../../../../swagger-ui/index.html?api=direitos-creditorios
