...
lang: "pt-br"
alternate_lang: 
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/adiantamentoDepositantes/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/adiantamentoDepositantes/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](../anexos/yml/operacoesDeCredito/overdraft-2-4-0.yml){:download="overdraft-2-4-0.yml"}.
