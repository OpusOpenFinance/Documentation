...
lang: "pt-br"
alternate_lang: 
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/financiamento/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/financiamento/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](../anexos/yml/operacoesDeCredito/financings-2-3-0.yml){:download="financings-2-3-0.yml"}.
...
[API-Financiamento]: ../../../../../../swagger-ui/index.html?api=financiamentos
