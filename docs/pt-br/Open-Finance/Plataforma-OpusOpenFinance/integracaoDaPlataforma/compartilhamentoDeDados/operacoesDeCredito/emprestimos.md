...
lang: "pt-br"
alternate_lang:
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/emprestimos/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/operacoesDeCredito/emprestimos/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](../anexos/yml/operacoesDeCredito/loans-2-4-0.yml){:download="loans-2-4-0.yml"}.
