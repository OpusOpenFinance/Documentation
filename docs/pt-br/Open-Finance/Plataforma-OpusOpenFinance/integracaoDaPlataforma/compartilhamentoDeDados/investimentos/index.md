...
lang: "pt-br"
alternate_lang: 
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/index/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/index/"
      lang: "es"
---
...
| API                        | Link                                      |
| -------------------------- |:-----------------------------------------:|
| Renda fixa bancária        | [Neste link](./rendaFixaBancaria.html)    |
| Renda fixa crédito         | [Neste link](./rendaFixaCredito.html)     |
| Renda variável             | [Neste link](./rendaVariavel.html)        |
| Títulos do tesouro direto  | [Neste link](./titulosTesouroDireto.html) |
| Fundos de investimento     | [Neste link](./fundosInvestimento.html)   |
