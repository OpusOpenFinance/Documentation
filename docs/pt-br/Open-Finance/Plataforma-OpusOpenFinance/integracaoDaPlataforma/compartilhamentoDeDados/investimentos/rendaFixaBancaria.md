...
lang: "pt-br"
alternate_lang: 
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaFixaBancaria/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaFixaBancaria/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](../anexos/yml/investimentos/bankFixedIncomes.yml){:download="bankFixedIncomes.yml"}.
...
[API-Renda-Fixa-Bancaria]: ../../../../../../swagger-ui/index.html?api=renda-fixa-bancaria
