...
lang: "pt-br"
alternate_lang: 
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaFixaCredito/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaFixaCredito/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](../anexos/yml/investimentos/creditFixedIncomes.yml){:download="creditFixedIncomes.yml"}.
...
[API-Renda-Fixa-Credito]: ../../../../../../swagger-ui/index.html?api=renda-fixa-credito
