...
lang: "pt-br"
alternate_lang: 
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaVariavel/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/investimentos/rendaVariavel/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](../anexos/yml/investimentos/variableIncomes.yml){:download="variableIncomes.yml"}.
