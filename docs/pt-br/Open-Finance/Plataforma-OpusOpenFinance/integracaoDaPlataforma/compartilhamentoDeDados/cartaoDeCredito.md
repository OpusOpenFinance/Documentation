...
lang: "pt-br"
alternate_lang:
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/cartaoDeCredito/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/cartaoDeCredito/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](./anexos/yml/creditCards-2-3-1.yml){:download="creditCards-2-3-1.yml"}.
...
[API-Cartao-de-credito]: ../../../../../swagger-ui/index.html?api=cartao-de-credito
