...
lang: "pt-br"
alternate_lang:
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/dadosCadastrais/"
      lang: "en"
    - path: "/Documentation/es/Open-Finance/Plataforma-OpusOpenFinance/integracaoDaPlataforma/compartilhamentoDeDados/dadosCadastrais/"
      lang: "es"
---
...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](./anexos/yml/customers-2-2-0.yml){:download="customers-2-2-0.yml"}.
