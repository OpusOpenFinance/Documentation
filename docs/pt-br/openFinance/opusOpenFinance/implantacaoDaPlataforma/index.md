...
alternate_lang: 
  - path: "/Documentation/en/opusOpenFinance/implantacaoDaPlataforma/index/"
    lang: "en"
  - path: "/Documentation/es/opusOpenFinance/implantacaoDaPlataforma/index/"
    lang: "es"
---
...
- Preparação das evidências para envio à OpenID ([certificações RP e OP](../../openFinanceBrasil/certificacoesECertificados.html));
...
- Integração dos sistemas de retaguarda da instituição ao produto, conforme o [perfil de participação da instituição financeira](../../openFinanceBrasil/perfisParticipacao/index.html). Tipicamente, [envolve a construção do *layer de integração*](../integracaoDaPlataforma/index.html) adaptado aos sistemas de retaguarda da instituição.
...
- Aquisição dos [certificados digitais](../../openFinanceBrasil/certificacoesECertificados.html);
