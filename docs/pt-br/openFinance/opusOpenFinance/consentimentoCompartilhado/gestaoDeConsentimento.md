...
lang: "pt-br"
alternate_lang:
    - path: "/Documentation/en/openFinance/opusOpenFinance/consentimentoCompartilhado/gestaoDeConsentimento/"
      lang: "en"
...
**Observação:** As telas apresentadas nesta seção estão contidas no Guia de Experiência do Usuário, Item 05 – Área de Gestão. Mais detalhes [no link](https://guia-de-ux-open-finance-brasil.scroll.site/guia-de-experi-ncia-open-finance-brasil/v.22.00.01/gestao-de-compartilhamento-de-dados).
...
![Telas de Gestão - Transmissão](./anexos/imagens/gestaoDeConsentimento/telasDeGestaoTransmissao.png)
...
![Tela de Painel de Controle de Consentimentos](./anexos/imagens/gestaoDeConsentimento/tela1PainelDeControleTransmissao.png)
...
![Tela de Revogação de Consentimento](./anexos/imagens/gestaoDeConsentimento/tela2RevogDeConsentTransmissao.png)
...
![Tela de Gestão de Contas Vinculadas](./anexos/imagens/gestaoDeConsentimento/tela3GestDeContVincTransmissao.png)
...
![Tela de Painel de Controle de Consentimentos - Recepção](./anexos/imagens/gestaoDeConsentimento/tela1PainelDeContrConsentRecepcao.png)
...
![Tela de Listagem de Compartilhamentos (Recebidos e Transmitidos)](./anexos/imagens/gestaoDeConsentimento/tela2ListDeCompartRecepcao.png)

#### Tela 3: Revogação de Consentimento

O usuário pode revogar um consentimento diretamente dessa tela, recebendo um aviso de que essa ação é irreversível e quais serviços serão afetados.

![Tela de Revogação de Consentimento](./anexos/imagens/gestaoDeConsentimento/tela3RevogConsentRecepcao.png)
