window.onload = () => {
  ...
  const apis = {
    ...
    // Open Data
    "en-open-data-acquiring": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-acquiring-services.yml`,
    "en-open-data-accounts": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-accounts.yml`,
    "en-open-data-capitalization": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-capitalization-bonds.yml`,
    "en-open-data-channels": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-channels.yml`,
    "en-open-data-credit-cards": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-credit-cards.yml`,
    "en-open-data-exchange": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-exchange.yml`,
    "en-open-data-financings": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-financings.yml`,
    "en-open-data-insurance": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-insurance.yml`,
    "en-open-data-investments": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-investments.yml`,
    "en-open-data-invoice-financings": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-invoice-financings.yml`,
    "en-open-data-loans": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-loans.yml`,
    "en-open-data-pension": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-pension.yml`,
    "en-open-data-unarranged": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis-dados-abertos/open-data-unarranged-account-overdraft.yml`,
    // Dados de Investimento
    "en-data-funds": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis/dados-investimento/oas-funds.yml`,
    "en-data-bank-fixed-incomes": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis/dados-investimento/oas-bank-fixed-incomes.yml`,
    "en-data-credit-fixed-incomes": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis/dados-investimento/oas-credit-fixed-incomes.yml`,
    "en-data-treasury-bonds": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis/dados-investimento/oas-treasury-bonds.yml`,
    "en-data-variable-incomes": `${base}/en/Open-Finance/Plataforma-OpusOpenFinance/apis/dados-investimento/oas-variable-incomes.yml`,
