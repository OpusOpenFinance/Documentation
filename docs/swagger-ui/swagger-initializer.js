window.onload = () => {
  ...
  const apis = {
    ...
    "es-open-data-capitalization": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-capitalizationBonds.yml`,
    "es-open-data-channels": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-opend-channels.yml`,
    "es-open-data-credit-cards": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-creditCards.yml`,
    "es-open-data-exchange": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-exchange.yml`,
    "es-open-data-financings": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-financings.yml`,
    "es-open-data-insurance": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-insurance.yml`,
    "es-open-data-investments": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-investments.yml`,
    "es-open-data-invoice-financings": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-invoiceFinancings.yml`,
    "es-open-data-loans": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-loans.yml`,
    "es-open-data-pension": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-pension.yml`,
    "es-open-data-unarranged": `${base}/es/Open-Finance/Plataforma-OpusOpenFinance/Integração/dadosAbertos/anexos/yml/es-open-unarrangedAccountOverdraft.yml`,
    //Portabilidade de Crédito
