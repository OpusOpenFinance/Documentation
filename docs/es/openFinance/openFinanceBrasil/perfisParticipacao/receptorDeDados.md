...
1. Completar el proceso de [setup (implantación)](../../opusOpenFinance/implantacaoDaPlataforma/index.html).
...
[API-Recepción]: ../../../../swagger-ui/index.html?api=es-otpp-recepcao_dados_of
