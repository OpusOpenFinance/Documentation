...
![Pantallas de Gestión - Transmisión](./anexos/imagens/gestaoDeConsentimento/es-telasDeGestaoTransmissao.png)
...
![Pantalla de Panel de Control de Consentimientos](./anexos/imagens/gestaoDeConsentimento/es-tela1PainelDeControleTransmissao.png)
...
![Pantalla de Revocación de Consentimiento](./anexos/imagens/gestaoDeConsentimento/es-tela2RevogDeConsentTransmissao.png)
...
![Pantalla de Gestión de Cuentas Vinculadas](./anexos/imagens/gestaoDeConsentimento/es-tela3GestDeContVincTransmissao.png)
...
![Pantalla de Panel de Control de Consentimientos - Recepción](./anexos/imagens/gestaoDeConsentimento/es-tela1PainelDeContrConsentRecepcao.png)
...
![Pantalla de Listado de Comparticiones (Recibidas y Transmitidas)](./anexos/imagens/gestaoDeConsentimento/es-tela2ListDeCompartRecepcao.png)

#### Pantalla 3: Revocación de Consentimiento

El usuario puede revocar un consentimiento directamente desde esta pantalla, recibiendo un aviso de que esta acción es irreversible y qué servicios se verán afectados.

![Pantalla de Revocación de Consentimiento](./anexos/imagens/gestaoDeConsentimento/es-tela3RevogConsentRecepcao.png)
