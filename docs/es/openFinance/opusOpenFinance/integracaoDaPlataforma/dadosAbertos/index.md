...
lang: "es"
alternate_lang: 
    - path: "/Documentation/pt-br/openFinance/opusOpenFinance/integracaoDaPlataforma/dadosAbertos/index/"
      lang: "pt-br"
    - path: "/Documentation/en/openFinance/opusOpenFinance/integracaoDaPlataforma/dadosAbertos/index/"
      lang: "en"
---
...
| API | Enlace Open API | Enlace Ejemplo JSON |
| :-: | :-------------: | :-----------------: |
| Canales de atención | [Enlace][Channels] | [JSON][Channels-JSON] |
| Cuentas | [Enlace][Accounts] | [JSON][Accounts-JSON] |
| Préstamos | [Enlace][Loans] | [JSON][Loans-JSON] |
| Financiamientos | [Enlace][Financings] | [JSON][Financings-JSON] |
| Adelanto a depositantes | [Enlace][Unarranged] | [JSON][Unarranged-JSON] |
| Derechos crediticios descontados | [Enlace][Inv-financings] | [JSON][Inv-financings-JSON] |
| Tarjeta de crédito | [Enlace][CreditCard] | [JSON][CreditCard-JSON] |
| Inversiones | [Enlace][Investments] | [JSON][Investments-JSON] |
| Seguros | [Enlace][Insurance] | [JSON][Insurance-JSON] |
| Adquirencia/Accreditation | [Enlace][Acquiring] | [JSON][Acquiring-JSON] |
| Títulos de capitalización | [Enlace][Capitalization] | [JSON][Capitalization-JSON] |
| Previsión | [Enlace][Pension] | [JSON][Pension-JSON] |
| Cambio | [Enlace][Exchange] | [JSON][Exchange-JSON] |
...
[Perfis-Open-Finance-Brasil]: ../../../openFinanceBrasil/perfisParticipacao/dadosAbertos.html
