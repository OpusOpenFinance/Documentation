...
lang: "es"
alternate_lang:
  - path: "/Documentation/pt-br/opusOpenFinance/implantacaoDaPlataforma/index/"
    lang: "pt-br"
  - path: "/Documentation/en/opusOpenFinance/implantacaoDaPlataforma/index/"
    lang: "en"
---
...
![Roadmap](./anexos/imagens/es-index-roadmap.png)
...
- Preparación de las evidencias para envío a OpenID ([certificaciones RP y OP](../../openFinanceBrasil/certificacoesECertificados.html));
...
- Construcción de las pantallas de la [jornada de consentimiento](../../openFinanceBrasil/jornadaConsentimento/index.html):
  - Para web, aplicación y handoff (si es necesario);
  - Según la [guía de experiencia del usuario](https://guia-de-ux-open-finance-brasil.scroll.site/guia-de-experi-ncia-open-finance-brasil/v.22.00.01/compartilhamento-de-dados) del *Open Finance Brasil*.
...
- Integración de los sistemas de respaldo de la institución al producto, conforme el [perfil de participación de la institución financiera](../../openFinanceBrasil/perfisParticipacao/index.html). Típicamente, [involucra la construcción del *layer de integración*](../integracaoDaPlataforma/index.html) adaptado a los sistemas de respaldo de la institución.
...
- Adquisición de los [certificados digitales](../../openFinanceBrasil/certificacoesECertificados.html);
