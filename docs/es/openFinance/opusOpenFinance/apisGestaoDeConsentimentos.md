...
Para descargar el archivo YAML/OAS que contiene la especificación de la API, haga clic [**aquí**](../openFinanceBrasil/perfisParticipacao/anexos/yml/es-oasOOFDados.yml){:download="es-oasOOFDados.yml"}.
