...
lang: "es"
alternate_lang:
    - path: "/Documentation/pt-br/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/operacoesDeCredito/direitosCreditorios/"
      lang: "pt-br"
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/operacoesDeCredito/direitosCreditorios/"
      lang: "en"
---
...
Para descargar el archivo YAML/OAS que contiene la especificación de la API haga clic [**aquí**](../anexos/yml/operacoesDeCredito/es-invoiceFinancings-2-3-0.yml){:download="es-invoiceFinancings-2-3-0.yml"}.
...
[API-Derechos-Crediticios]: ../../../../../../swagger-ui/index.html?api=es-direitos-creditorios
