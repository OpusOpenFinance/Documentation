...
lang: "es"
alternate_lang:
    - path: "/Documentation/pt-br/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/investimentos/rendaVariavel/"
      lang: "pt-br"
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/investimentos/rendaVariavel/"
      lang: "en"
---
...
Para descargar el archivo YAML/OAS que contiene la especificación de la API haga clic [**aquí**](../anexos/yml/investimentos/es-variableIncomes.yml){:download="es-variableIncomes.yml"}.
...
[API-Renta-Variable]: ../../../../../../swagger-ui/index.html?api=es-data-variable-incomes
