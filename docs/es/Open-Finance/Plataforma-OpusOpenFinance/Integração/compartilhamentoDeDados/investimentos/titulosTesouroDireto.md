...
lang: "es"
alternate_lang:
    - path: "/Documentation/pt-br/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/investimentos/titulosTesouroDireto/"
      lang: "pt-br"
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/Integração/compartilhamentoDeDados/investimentos/titulosTesouroDireto/"
      lang: "en"
---
...
Para descargar el archivo YAML/OAS que contiene la especificación de la API haga clic [**aquí**](../anexos/yml/investimentos/es-treasuryBonds.yml){:download="es-treasuryBonds.yml"}.
...
[API-Tesoro-Directo]: ../../../../../../swagger-ui/index.html?api=es-data-treasury-bonds
