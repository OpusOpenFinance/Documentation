...
Para descargar el archivo YAML/OAS que contiene la especificación de la API haga clic [**aquí**](customers-2-2-0.yml){:download="customers-2-2-0.yml"}.
...
[API-Datos-catastrales]: ../../../../swagger-ui/index.html?api=Dados-cadastrais
