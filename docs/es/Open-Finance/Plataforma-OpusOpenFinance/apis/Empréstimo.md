...
lang: "es"
alternate_lang:
    - path: "/Documentation/pt-br/Open-Finance/Plataforma-OpusOpenFinance/apis/Empréstimo/"
      lang: "pt-br"
    - path: "/Documentation/en/Open-Finance/Plataforma-OpusOpenFinance/apis/Empréstimo/"
      lang: "en"
---
...
Para descargar el archivo YAML/OAS que contiene la especificación de la API haga clic [**aquí**](loans-2-4-0.yml){:download="loans-2-4-0.yml"}.
...
[API-Préstamo]: ../../../../swagger-ui/index.html?api=Empréstimo
